...
public class MainApp extends Application {
    ...
    private Parent createContent() {
        ...
        ImageView title = new ImageView(new Image(getClass().getResource("D:\\UET lessons\\demo\\resource\\images\\images\\title.png").toExternalForm()));
        title.setFitWidth(178);
        title.setFitHeight(50);
        title.setLayoutX(200);
        title.setLayoutY(50);

        ImageView flappyBird = new ImageView(new Image(getClass().getResource("D:\\UET lessons\\demo\\resource\\images\\images\\bird2.png").toExternalForm()));
