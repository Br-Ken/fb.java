...
public class FlappyBird extends Application {
    ...
    private ImageView setBackground() {
        ...
        String filePath = bg > 0 ? "D:\\UET lessons\\demo\\resource\\images\\images\\background.png" : "D:\\UET lessons\\demo\\resource\\images\\images\\background_night.png";
    ...
    private void setLabels() {
        ...
        gameOver = new ImageView(new Image(getClass().getResource("D:\\UET lessons\\demo\\resource\\images\\images\\game_over.png").toExternalForm()));
        gameOver.setFitWidth(178);
        gameOver.setFitHeight(50);
        gameOver.setLayoutX(110);
        gameOver.setLayoutY(100);

        startGame = new ImageView(new Image(getClass().getResource("D:\\UET lessons\\demo\\resource\\images\\images\\ready.png").toExternalForm()));
    ...
    private void setFloor() {
        ...
        firstFloor.resizeImage("D:\\UET lessons\\demo\\resource\\images\\images\\floor.png", 400, 140);
        firstFloor.setPositionXY(0, APP_HEIGHT - 100);
        firstFloor.setVelocity(-.4, 0);
        firstFloor.render(birdGC);

        secondFloor = new Sprite();
        secondFloor.resizeImage("D:\\UET lessons\\demo\\resource\\images\\images\\floor.png", 400, 140);
