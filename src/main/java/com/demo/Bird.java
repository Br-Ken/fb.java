...
public class Bird {
    ...
    public void setFlightAnimation() {
        ...
        bird2.resizeImage("D:\\UET lessons\\demo\\resource\\images\\images\\bird2.png", BIRD_WIDTH, BIRD_HEIGHT);
        bird2.setPositionXY(locationX, locationY);

        Sprite bird3 = new Sprite();
        bird3.resizeImage("D:\\UET lessons\\demo\\resource\\images\\images\\bird1.png", BIRD_WIDTH, BIRD_HEIGHT);
        bird3.setPositionXY(locationX, locationY);

        Sprite bird4 = new Sprite();
        bird4.resizeImage("D:\\UET lessons\\demo\\resource\\images\\images\\bird3.png", BIRD_WIDTH, BIRD_HEIGHT);
