...
public class Pipe {
    ...
    public Pipe(boolean isFaceUp, int height) {
        ...
        this.pipe.resizeImage(isFaceUp ? "D:\\UET lessons\\demo\\resource\\images\\images\\up_pipe.png" : "D:\\UET lessons\\demo\\resource\\images\\images\\down_pipe.png", 70, height);
        this.width = 70;
        this.height = height;
        this.locationX = 400;
